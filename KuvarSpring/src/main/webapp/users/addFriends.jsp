...
<title>Coolinarika - ADD FRIENDS</title>
</head>
<body>
	<div>
			...
			<div data-spy="scroll" class="tabbable-panel">
				<div class="tabbable-line">
					<ul class="nav nav-tabs ">
						...
						<li><a href="/Kuvar/users/favouriteCategories.jsp" data-toggle="tab" target="_top"> <strong> My favourite categories </strong></a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab_default_4">
								<c:if test="${!empty friendRequests }">
									<form action="/Kuvar/controller/acceptRequest" method="post">
